...
label day2_park:
    scene bg park
    "Свежий воздух помогает проветрить мозги."
...
label day2_dorm:
    ...
    # Можно было бы добавить +10 к матану, но у нас нет статов, только скилл игрока.
    # Но знание, что ты готовился, успокаивает.
