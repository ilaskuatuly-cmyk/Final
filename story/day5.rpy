...
label endings:
    ...
    "В группе пишут что выставили результаты. Пора проверить мудл."
...
label ending_balanced:
    ...
    "Ты не только все сдал, но и сдружился с группашами."
    return
...
label ending_burnout:
    ...
    "Может, стоило больше общаться с ребятами? Или больше учить? Уже не важно."
    return
